...
enum ProductStatus{initial,loading,completed,addQty,error}
class ProductState extends Equatable{
  ...
  ProductState copyWith({ProductStatus? status,String? msg,ProductModel? product,ProductByIdModel? model}){
